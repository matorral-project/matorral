...
from apps.dashboard.urls import workspace_urlpatterns as web_workspace_urls
...
urlpatterns = [
    ...
    # Workspace standalone URLs (list, create, invitations) — must come before
    # the scoped patterns so fixed paths like "create/" aren't swallowed by
    # the <workspace_slug> catch-all.
