...
class DefaultWorkspaceCreationTest(TestCase):
    def test_workspace_created_for_new_user(self):
        user = User.objects.create(username="alice@example.com", email="alice@example.com")
    ...
    def test_two_users_get_separate_workspaces(self):
        user1 = User.objects.create(username="user1@example.com", email="user1@example.com")
        user2 = User.objects.create(username="user2@example.com", email="user2@example.com")
